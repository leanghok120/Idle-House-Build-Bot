...
Cords
{
    The cordinates of the house: X:  660 Y:  559 RGB: (222, 121,  89)
    The cordinates of the collect button: X: 1254 Y:  557 RGB: (255, 250, 190)
    The cordinates of the House size upgrade button: X: 1386 Y:  383 RGB: ( 30, 180,  30)
    The cordinates of the Bricks per click upgrade button: X: 1387 Y:  308 RGB: ( 30, 180,  30)
